...
print("Searching Business detailed results...")
...
for number, outbound in enumerate(valid_outbounds[:3], 1):
    ...
    if not valid_returns:
        print("No valid return <= 300 min layover.")
        continue
